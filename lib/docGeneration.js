...
function createDoc(templateJsonLocation, markdownOutputLocation, templateJsonFileName = 'template.json', vsCodePrefix = 'pre', markdownFileName, renderWithoutPrefixes = false) {
    ...
    const snippet = snippets_1.createSnippet(templateJson, vsCodePrefix, renderWithoutPrefixes);
